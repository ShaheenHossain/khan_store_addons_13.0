...
{
    'name': 'Eagle Customize(Debranding, My Eagle)',
    'version': '13.19.09.14',
    'author': 'Sunpop.cn',
    ...
    eagle 13,12,11,10,9 support.
    Easy Delete data.reset account chart.
    eagle debrand, eagle debranding, customize my eagle. 
    """,
    'description': """
    
    App Eagle Customize(Debranding Title,Language,Documentation,Quick Debug)
    ============
    White label eagle.
    Support Eagle 13, 12, 11, 10, 9.communicate and enterprise 
    ...
    27. Add eagle 13 support, Just install this app on eagle 13, master branch of eagle github.
    ...
    'data': [
        'views/app_eagle_customize_views.xml',
