eagle.define('app_eagle_customize.UserMenu', function (require) {
    "use strict";
        ...
        init: function () {
            ...
            self._rpc({
                ...
                _.each(res, function (lang) {
                    ...
                    lang_list += '<a role="menuitem" href="#" class="dropdown-item" data-lang-menu="lang" data-lang-id="' + lang['code']
                        + '"><img class="flag" src="app_eagle_customize/static/src/img/flags/' + lang['code'] + '.png"/>' + lang['name'] + a + '</a>';
                });
            ...
            self._rpc({
                ...
                $.each(res, function (key, val) {
                    ...
                    //注意， eagle12，主用户id=2, 加了个 __system__
